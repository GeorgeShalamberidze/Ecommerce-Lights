  ...
  const navbarItems = [
    {
      name: "DIY Kits",
      aTag: [
        { href: "/collection/all-diy-kits", content: "All DIY Kits" },
        { href: "/collection/2-x-2", content: "2'x 2'" },
        { href: "/collection/2-x-4", content: "2'x 4'" },
        { href: "/collection/3-x-3", content: "3'x 3'" },
        { href: "/collection/4-x-4", content: "4'x 4'" },
        { href: "/collection/5-x-5", content: "5'x 5'" },
        { href: "/collection/mass-medical", content: "Mass Medical" },
        { href: "/collection/supplemental", content: "Supplemental" },
      ],
      icon: <BiChevronDown />,
    },
    {
