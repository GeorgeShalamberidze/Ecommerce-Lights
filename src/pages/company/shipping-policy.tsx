    ...
    <Layout title="Shipping Policy">
      <div className="flex text-center justify-center items-center m-20">
        <div className=" max-w-2xl">
          <h1 className="text-3xl font-bold mb-10">Shipping Policy</h1>
          <h3>
            <p>
            ...
            <br />
            <p>
              International Shipping: We offer international shipping to select
              countries. Please note that international shipments may be subject
              to import duties and taxes, which are the responsibility of the
              customer. We recommend that you contact your local customs office
              for more information before placing your order. Order Tracking:
              Once your order has shipped, you will receive a shipping
              confirmation email with a tracking number that you can use to
              track your package.
            </p>
            <br />
            <p>
              Shipping Carriers: We work with reputable shipping carriers to
              ensure that your package is delivered safely and on time. Our
              shipping carriers include [insert names of shipping carriers].
              Shipping Restrictions: We currently do not offer shipping to P.O.
              boxes or APO/FPO addresses. Additionally, we reserve the right to
              refuse or cancel any orders that we believe may be fraudulent or
